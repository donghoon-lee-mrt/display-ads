...
from utils.ai_motion_grabcut import animate_image_grabcut, MotionSpec


def main() -> None:
    ap = argparse.ArgumentParser(description="Animate single image with GrabCut-based parallax")
    ap.add_argument("image_url", type=str)
    ap.add_argument("--out", type=str, default="motion_grabcut.mp4")
